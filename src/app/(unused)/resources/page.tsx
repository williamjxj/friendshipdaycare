  ...
  const resourceData: ResourceCategory[] = [
    {
      ...
      resources: [
        {
          title: "Parent Handbook 2024-2025",
          description: "Complete guide to policies, procedures, and what to expect at Friendship Corner",
          type: "PDF",
          icon: "📖",
          downloadUrl: "#"
        },
        {
          ...
          description: "Fillable PDF application form for new families",
          type: "PDF",
          icon: "✍️",
          downloadUrl: "#"
        },
        {
          ...
          description: "Required health and emergency contact information",
          type: "PDF",
          icon: "🏥",
          downloadUrl: "#"
        },
        {
          ...
          description: "Annual consent form for off-site activities",
          type: "PDF",
          icon: "🚌",
          downloadUrl: "#"
        }
      ...
      resources: [
        {
          ...
          description: "Everything your child needs for a successful first day",
          type: "Checklist",
          icon: "✅"
        },
        {
          title: "Separation Anxiety Guide",
          description: "Tips for helping your child adjust to daycare",
          type: "Guide",
          icon: "🤗"
        },
        {
          title: "What to Pack Daily",
          description: "Daily essentials your child should bring",
          type: "Checklist",
          icon: "🎒"
        },
        {
          title: "Potty Training Partnership",
          description: "How we support families through potty training",
          type: "Guide",
          icon: "🚽"
        }
      ]
      ...
      resources: [
        {
          ...
          description: "Simple activities you can do at home (Ages 2-3)",
          type: "Guide",
          icon: "👶"
        },
        {
          title: "Practical Life Skills Activities",
          description: "Help your child develop independence at home",
          type: "Guide",
          icon: "🧹"
        },
        {
          title: "Creating a Prepared Environment",
          description: "Set up your home to support your child's development",
          type: "Article",
          icon: "🛋️"
        },
        {
          title: "Montessori-Inspired Toys & Materials",
          description: "Recommended toys that support learning",
          type: "Guide",
          icon: "🧸"
        }
      ]
      ...
      resources: [
        {
          ...
          description: "Nutritious, kid-friendly lunch suggestions",
          type: "Guide",
          icon: "🥗"
        },
        {
          title: "Illness Policy Quick Reference",
          description: "When to keep your child home and when they can return",
          type: "Checklist",
          icon: "🤒"
        },
        {
          title: "Allergy Management Plan",
          description: "How we handle food allergies and keep children safe",
          type: "Guide",
          icon: "⚠️"
        },
        {
          title: "Sleep Tips for Young Children",
      ...
      resources: [
        {
          ...
          description: "What children should know before starting kindergarten",
          type: "Checklist",
          icon: "📝"
        },
        {
          title: "Pre-Reading Activities",
          description: "Fun ways to build literacy skills at home",
          type: "Guide",
          icon: "📚"
        },
        {
          title: "Math Readiness Through Play",
          description: "Everyday activities that teach math concepts",
          type: "Guide",
          icon: "🔢"
        },
        {
          title: "Social-Emotional Development",
          description: "Supporting your child's emotional intelligence",
          type: "Article",
          icon: "❤️"
        }
      ]
    },
    {
      ...
      resources: [
        {
          title: "Summer Activity Ideas",
          description: "Keep learning going during summer break",
          type: "Guide",
          icon: "☀️"
        },
        {
          title: "Holiday Traditions Around the World",
          description: "Celebrate diversity with your family",
          type: "Article",
          icon: "🌍"
        },
        {
          title: "Birthday Celebration Guidelines",
          description: "How to celebrate birthdays at our center",
          type: "Guide",
          icon: "🎂"
        },
        {
          title: "Outdoor Play in All Weather",
          description: "Why outdoor play matters and how to dress for it",
          type: "Article",
          icon: "🌦️"
        }
      ]
  ...
  const handbookSections = [
    {
      ...
      items: ["Director's Welcome", "Our Mission & Vision", "Montessori Approach", "Biblical Values Integration"]
    },
    {
      title: "Daily Operations",
      items: ["Hours of Operation", "Daily Schedule", "Drop-off & Pick-up", "Attendance Policy"]
    },
    {
      title: "Health & Safety",
      items: ["Illness Policy", "Medication Administration", "Allergy Management", "Emergency Procedures"]
    },
    {
      title: "Curriculum & Learning",
      items: ["Program Overview", "Learning Areas", "Assessment & Progress", "Transitions"]
    },
    {
      title: "Policies & Procedures",
      items: ["Tuition & Payment", "Withdrawal Policy", "Behavior Guidance", "Parent Involvement"]
    },
    {
      title: "Communication",
      items: ["Parent-Teacher Communication", "Conferences", "Updates & Newsletters", "Concerns & Feedback"]
    }
  ];
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-grow">
                          ...
                          {resource.downloadUrl ? (
                            ...
                            <button className="inline-flex items-center gap-2 text-blue-600 dark:text-blue-400 font-semibold text-sm hover:underline">
                              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="max-w-3xl mx-auto bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 rounded-2xl p-8 text-center">
            ...
            <form className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <input 
                ...
                className="flex-grow px-4 py-3 rounded-lg border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none"
              />
              <button 
                type="submit"
